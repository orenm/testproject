...
from puresasl.client import SASLClient # pip install pure-sasl
...
# test against ejabbered:
# python boshclient.py https://kuku.no-ip.org:5280/http-bind <name>@kuku.no-ip.org <pass>
